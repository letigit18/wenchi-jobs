  ...
  setMegaMenuOpen(true)
    ...
    return(
        <header className={styles.header}>
            <nav className={styles.navBar}>
                ...
                <ul className={styles.menu} >
                    ...
                    <Link className={`${styles.link} ${styles.dropdown}`} href="/">{isEnglish ? 'Employers' : 'Hojjechiistota'}<i className='bx bx-chevron-down'></i></Link>
                     <ul className={styles.dropdownMenu}>
                        ...
                        <Link href="/employers/post-jobs"><li className={styles.menuItem}>{isEnglish ? 'Post jobs' : 'Hoji maxxansii'}</li></Link>
                        <Link href="/employers/registration"><li className={styles.menuItem}>{isEnglish ? 'Register' : 'Haaraa Galmeessii'}</li></Link>
                        <Link href="/employers/registration"><li className={styles.menuItem}>{isEnglish ? 'Login' : 'Seenii'}</li></Link>
                ...
                <ul className={mobileMenuOpen ? `${styles.mobileMenu} ${styles.active}` : styles.mobileMenu} ref={mobileMenuRef}>
                    ...
                    <Link className={`${styles.link} ${styles.dropdown}`} href="/">Employers  <i className='bx bx-chevron-down'></i></Link>
                     <ul className={styles.dropdownMenu}>
                        <li className={styles.menuItem} onClick={()=>{setMobileMenuOpen(false)}}>Login</li>
                        <li className={styles.menuItem} onClick={()=>{setMobileMenuOpen(false)}}>Register</li>
                 ...
                 <div className={styles.accountContainer} >
                  <div className={styles.listsContainer}>
                    ...
                    <Link href={'/CV-Builder'}>
                      ...
                      <li><span><i class='bx bx-edit'></i></span> <p>Change password</p></li>
          ...
          {!loading && !isLogin && (
            <li  className={styles.menuItem}>
                <Link  href="#" className={`${styles.link} ${styles.dropdown} ${styles.btnOrange}`}>My Account <i className='bx bx-chevron-down'></i></Link>
                <ul className={styles.dropdownMenu}>
                  <li className={styles.menuItem} onClick={()=>{setSignupOpen(true)}}>Create Account</li>
                  <li className={styles.menuItem}><Link href={'/auth'}>Signin</Link></li>
                  <li className={styles.menuItem}><Link href={'/forget-password'}>Forget password?</Link></li>
                </ul>
